...
test/integration/targets/setup_paramiko/install-MacOSX-10-python-3.yml
...
test/integration/targets/setup_paramiko/uninstall-MacOSX-10-python-3.yml
...
test/integration/targets/user/tasks/expires_local.yml
